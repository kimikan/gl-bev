use gl_wrapper::set_attribute;
use gl_wrapper::Buffer;
use gl_wrapper::ShaderProgram;
use gl_wrapper::Texture;
use gl_wrapper::VertexArray;
use gl_wrapper::{Shader, ShaderError};
...
impl Renderer {
    pub fn new() -> Result<Self, RendererInitError> {
        unsafe {
            ...
            texture1.load(&Path::new("assets/J5.png"))?;
